...
int Painter_DrawTextC(int x, int y, const char *text, Color::E);
...
int Painter_DrawTextInRectWithTransfersC(int x, int y, int width, int height, const char *text, Color::E);
