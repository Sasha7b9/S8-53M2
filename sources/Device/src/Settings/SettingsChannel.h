...
#define SET_INVERSE_B           (SET_INVERSE(Chan::B))          // set.chan[B].inverse
...
#define SET_ENABLED_B           SET_ENABLED(Chan::B)            // set.chan[B].enable
...
#define SET_BALANCE_ADC_B       (SET_BALANCE_ADC(Chan::B))      // set.chan[B].balanceShiftADC
