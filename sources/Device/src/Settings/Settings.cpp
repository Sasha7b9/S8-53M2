...
static const Settings defaultSettings =
{
    ...
    // measures
    {
        ...
        //{0, 200},                 // начальные значени€ курсоров напр€жени€ дл€ зоны измерений
...
void Settings::Load(bool _default)
{
    ...
    if (_default)
    {
        ...
        memcpy((void *)rShiftAddA, (void *)&RSHIFT_HAND(Chan::A, 0, 0), Range::Count * ModeCouple::Count * sizeof(int16)); // —начала сохран€ем несбрасываемые настройки
        ...
        memcpy((void *)&set, (void *)(&defaultSettings), sizeof(set));                // ѕотом заполн€ем значени€ми по умолчанию

        memcpy((void *)&RSHIFT_HAND(Chan::A, 0, 0), (void *)rShiftAddA, 2 * Range::Count * 2);  // » восстанавливаем несбрасываемые настройки
