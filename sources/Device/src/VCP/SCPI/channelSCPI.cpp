...
void SCPI::CHANNEL::INPUT(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:INPUT %s", ch.ToNumber(), ch.Enabled() ? "ON" : "OFF");
        }
    LEAVE_ANALYSIS
}
...
void SCPI::CHANNEL::COUPLE(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:COUPLING %s", ch.ToNumber(), map[SET_COUPLE(ch)].key);
        }
    LEAVE_ANALYSIS
}
...
void SCPI::CHANNEL::FILTR(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:FILTR %s", ch.ToNumber(), SET_FILTR(ch) ? "ON" : "OFF");
        }
    LEAVE_ANALYSIS
}
...
void SCPI::CHANNEL::INVERSE(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:SET_INVERSE %s", ch.ToNumber(), SET_INVERSE(ch) ? "ON" : "OFF");
        }
    LEAVE_ANALYSIS
}
...
void SCPI::CHANNEL::RANGE(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:SET_RANGE %s", ch.ToNumber(), map[SET_RANGE(ch)].key);
        }
    LEAVE_ANALYSIS
}
...
void SCPI::CHANNEL::FACTOR(uint8 *buffer)
{
    ...
    ENTER_ANALYSIS
        ...
        {
            SCPI_SEND(":CHANNEL%d:PROBE %s", ch.ToNumber(), map[SET_DIVIDER(ch)].key);
        }
    LEAVE_ANALYSIS
}
